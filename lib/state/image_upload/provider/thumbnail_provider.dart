...
import 'package:riverpod_instagram_clone/state/image_upload/models/image_with_aspect.dart';
import 'package:riverpod_instagram_clone/state/image_upload/models/thumbnail_request.dart';
import 'package:video_thumbnail/video_thumbnail.dart';

final thumbnailProvider =
    FutureProvider.family.autoDispose<ImageWithAspectRatio, ThumnnailRequest>(
  (ref, ThumnnailRequest request) async {
    final Image image;
